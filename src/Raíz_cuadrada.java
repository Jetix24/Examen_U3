...
// Se crea la clase Raíz_cuadrada que hereda de Operaciones
public class Raíz_cuadrada extends Operaciones{

    // Se crea el constructor de Raíz_cuadrada que utiliza los parametros obtenidos de Operaciones 
    public Raíz_cuadrada(double v1, double v2) {
    ...
    public double Operar(){
       // Se iguala la operación al valor obtenido por el método sqrt que viene de la clase Math a la variable resultado
    ...
    public void Mostrar_Raíz_Cuadrada(){
          JOptionPane.showMessageDialog(null," √" +v1+ " = " +resultado ,"Raíz Cuadrada",1);
    }
    // Se crea el método Get_Raíz_Cuadrada que ejecutara todos los métodos de la clase con solo una llamada
    public void Get_Raíz_Cuadrada(){
        No_1();
         // Al ultilizar el botón cancelar se le asignara el valor de 0.00000001 por lo que no se ejecutara lo que sigue del método
         if(v1 != 0.00000001){
           Operar();
           Mostrar_Raíz_Cuadrada();
         }
    }
