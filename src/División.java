...
// Se crea la clase División que hereda de Operaciones
public class División extends Operaciones {

    // Se crea el constructor de División que utiliza los parametros obtenidos de Operaciones 
    public División(double v1, double v2) {
    ...
    public void Mostrar_División(){
          JOptionPane.showMessageDialog(null,v1 + " / " +v2+ " = " +resultado ,"División",1);
    }
    // Se crea el método Get_División que ejecutara todos los métodos de la clase con solo una llamada
    public void Get_División(){
        No_1();
